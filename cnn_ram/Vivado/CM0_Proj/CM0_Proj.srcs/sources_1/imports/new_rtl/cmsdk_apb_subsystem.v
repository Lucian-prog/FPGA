...
// --------------------------------------------------------------------------
  ...
  output wire           ext3_psel,
  output wire           ext6_psel,
  output wire           ext7_psel,
  output wire           ext9_psel,

  input  wire   [31:0]  ext3_prdata,
  input  wire           ext3_pready,
  input  wire           ext3_pslverr,

  input  wire   [31:0]  ext6_prdata,
  input  wire           ext6_pready,
  input  wire           ext6_pslverr,

  input  wire   [31:0]  ext7_prdata,
  input  wire           ext7_pready,
  input  wire           ext7_pslverr,

  input  wire   [31:0]  ext9_prdata,
  input  wire           ext9_pready,
  input  wire           ext9_pslverr,
  ...
  assign apbsubsys_interrupt[31:0] = {
                   ...
                   1'b0,                     		 // 9
                   i_dualtimer2_int,                 // 8
                   i_timer1_int,                     // 7 (GPIO #1 combined interrupt)
                   i_timer0_int,                     // 6 (GPIO #0 combined interrupt)
                   i_uart1_overflow_int,             // 5
                   i_uart0_overflow_int,             // 4
                   i_uart1_txint,                    // 3
                   i_uart1_rxint,                    // 2
                   i_uart0_txint,                    // 1
                   i_uart0_rxint};                   // 0
