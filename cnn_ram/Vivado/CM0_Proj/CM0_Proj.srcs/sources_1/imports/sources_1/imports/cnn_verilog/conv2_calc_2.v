...
initial begin
	$readmemh("D:/Design/training_202503/proj/0225/CNN-Implementation-in-Verilog-master/pyTorch/mnist_cnn/conv2_weight_21.txt", weight_1);
	$readmemh("D:/Design/training_202503/proj/0225/CNN-Implementation-in-Verilog-master/pyTorch/mnist_cnn/conv2_weight_22.txt", weight_2);
	$readmemh("D:/Design/training_202503/proj/0225/CNN-Implementation-in-Verilog-master/pyTorch/mnist_cnn/conv2_weight_23.txt", weight_3);
...
always @ (posedge cnn_data_valid) begin
	if(~rst_n) begin
		valid_out_calc <= 0;
    	//conv_out_calc <= 0;
	end
