...
//------------------------------------------------------------------------------
  ...
  AHB_BusMatrix_3x6_L1_default_slave u_AHB_BusMatrix_3x6_L1_default_slave (
  ...
  always @ (
    ...
    begin : p_addr_out_port_comb
      case (remapping_dec)  // Composition: REMAP[0]
        1'b0 : begin
          // Static address region 0x00000000-0x0001ffff
          if (((decode_addr_dec >= 22'h000000) & (decode_addr_dec <= 22'h00007f))
                           | ((data_out_port == 4'b0000) & (trans_dec == 2'b00)))
             addr_out_port = 4'b0000;  // Select Output port MI0

          // Static address region 0x20000000-0x2001ffff
          else if (((decode_addr_dec >= 22'h080000) & (decode_addr_dec <= 22'h08007f))
                           | ((data_out_port == 4'b0001) & (trans_dec == 2'b00)))
             addr_out_port = 4'b0001;  // Select Output port MI1

          // Static address region 0x30000000-0x307fffff
          else if (((decode_addr_dec >= 22'h0c0000) & (decode_addr_dec <= 22'h0c1fff))
                           | ((data_out_port == 4'b0010) & (trans_dec == 2'b00)))
             addr_out_port = 4'b0010;  // Select Output port MI2

          // Static address region 0x30800000-0x30ffffff
          else if (((decode_addr_dec >= 22'h0c2000) & (decode_addr_dec <= 22'h0c3fff))
                           | ((data_out_port == 4'b0011) & (trans_dec == 2'b00)))
             addr_out_port = 4'b0011;  // Select Output port MI3

          // Static address region 0x40000000-0x4fffffff
          else if (((decode_addr_dec >= 22'h100000) & (decode_addr_dec <= 22'h13ffff))
                           | ((data_out_port == 4'b0100) & (trans_dec == 2'b00)))
             addr_out_port = 4'b0100;  // Select Output port MI4

          // Static address region 0x60000000-0x6fffffff
          else if (((decode_addr_dec >= 22'h180000) & (decode_addr_dec <= 22'h1bffff))
        ...
        1'b1 : begin
          ...
          // Remapped address region 0x20000000-0x2001ffff due to REMAP[0]
          else if (((decode_addr_dec >= 22'h080000) & (decode_addr_dec <= 22'h08007f))
                           | ((data_out_port == 4'b0001) & (trans_dec == 2'b00)))
             addr_out_port = 4'b0001;  // Select Output port MI1

          // Remapped address region 0x30000000-0x307fffff due to REMAP[0]
          else if (((decode_addr_dec >= 22'h0c0000) & (decode_addr_dec <= 22'h0c1fff))
                           | ((data_out_port == 4'b0010) & (trans_dec == 2'b00)))
             addr_out_port = 4'b0010;  // Select Output port MI2

          // Remapped address region 0x30800000-0x30ffffff due to REMAP[0]
          else if (((decode_addr_dec >= 22'h0c2000) & (decode_addr_dec <= 22'h0c3fff))
                           | ((data_out_port == 4'b0011) & (trans_dec == 2'b00)))
             addr_out_port = 4'b0011;  // Select Output port MI3

          // Remapped address region 0x40000000-0x4fffffff due to REMAP[0]
          else if (((decode_addr_dec >= 22'h100000) & (decode_addr_dec <= 22'h13ffff))
                           | ((data_out_port == 4'b0100) & (trans_dec == 2'b00)))
             addr_out_port = 4'b0100;  // Select Output port MI4

          // Remapped address region 0x60000000-0x6fffffff due to REMAP[0]
          else if (((decode_addr_dec >= 22'h180000) & (decode_addr_dec <= 22'h1bffff))
                           | ((data_out_port == 4'b0101) & (trans_dec == 2'b00)))
             addr_out_port = 4'b0101;  // Select Output port MI5
